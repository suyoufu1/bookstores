...
<body >
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/FindMessegeServlet"
		method="post">
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff"><input type="text"
									name="id" size="15" value="${messege.id}" id="Form1_userName" class="bg" />
								</td>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>留言列表</strong>
					</TD>
				</tr>
				<tr>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="18%">用户编号</td>
								<td align="center" width="9%">留言信息</td>
							...
							<c:forEach items="${pageResult.list}" var="user">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="23">${messege.id }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="18%">${messege.userid }</td>
										<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%">${messege.msg }</td>
									...
									<a href="javascript:deleteUser('${messege.userid}','${messege.id}')">
											<img
											src="${pageContext.request.contextPath}/admin/images/i_del.gif"
											width="16" height="16" border="0" style="CURSOR: hand">
									</a>
