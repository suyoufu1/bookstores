 ...
 */
@WebServlet("/MessegeListServlet")
public class MessegeListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//创建service
		IMessegeService messegeListService=new MessegeServiceImpl();
		PageBean<Messege> pageResult=messegeListService.findUserByPage(Integer.parseInt(page));
		//发送request请求，设置
